...
urlpatterns = [
    ...
    # 게시글 삭제 #
    path('community_sorted_date/<int:pk>/delete_notice/', views.delete_notice),
    path('community_sorted_good/<int:pk>/delete_notice/', views.delete_notice),
    path('community_sorted_comment/<int:pk>/delete_notice/', views.delete_notice),
